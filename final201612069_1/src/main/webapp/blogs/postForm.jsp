            ...
            <div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <div class="my-5">
                    ...
                    <form id="contactForm" action="post.do" method="post">
                        ...
                        <div class="form-floating">
                            <input class="form-control" name="email" id="email" value="${sessionScope.logined.email}" type="text" placeholder="Enter your email..." data-sb-validations="required,email" readonly />
                            <label for="email">Email address</label>
                            <div class="invalid-feedback" data-sb-feedback="email:required">An email is required.</div>
                            <div class="invalid-feedback" data-sb-feedback="email:email">Email is not valid.</div>
                        </div>
                        <div class="form-floating">
                            <input class="form-control" name="title" id="title" type="tel" placeholder="Enter your title..." data-sb-validations="required" />
                            <label for="title">Title</label>
                            <div class="invalid-feedback" data-sb-feedback="phone:required">A phone number is required.</div>
                        </div> <!-- name 과 value는 백엔드 id는 프론트엔드-->
                        <div class="form-floating">
