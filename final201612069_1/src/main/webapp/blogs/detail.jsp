            ...
            <div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <div class="my-5">
                    ...
                    <form id="contactForm">
                        ...
                        <div class="form-floating">
                            <input class="form-control" name="title" value="${blog.title}" id="title" type="text" placeholder="Enter your title..." data-sb-validations="required" />
                        ...
                        <a class="btn btn-primary text-uppercase" href="updateForm.do?id=${requestScope.blog.id}">수정</a>
                        <a class="btn btn-primary text-uppercase" href="delete.do?id=${blog.id}">삭제</a>
<%--                        <a href="delete.do?id=${blog.id}">삭제</a>--%>
<%--                        <%--%>
<%--                            session.getAttribute("blog"); //session.setAtrribute("blog");--%>
